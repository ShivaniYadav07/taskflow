  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 p-4">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute -right-40 -top-40 h-[600px] w-[600px] rounded-full bg-violet-600/25 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 h-[600px] w-[600px] rounded-full bg-indigo-600/20 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-sm animate-fade-in">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">Create your account and start organizing</p>
        </div>
